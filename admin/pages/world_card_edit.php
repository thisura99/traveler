        ...
        <div class="card-body">
            ...
            ?>
                    <form action="query2.php" method="POST" enctype="multipart/form-data">
                      <input type="hidden" name="eid" class="eid" value="<?php echo $id; ?>">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <h6 class="text-danger">NOTE: Please remember the selected URL for future editing.</h6>
                              <h6 class="text-primary">Recommended: Add one country and update related details before adding another country.</h6>
                              <select class="form-control" id="url" name="eurl">
                                <option><?php echo $row['url']; ?></option>
                                <?php
                      ...
                      <div class="modal-footer">
                        <a href="world_card.php" class="btn btn-danger cancel-button">Cancel</a>
                        <button type="submit" name="update_world_card_btn" class="btn btn-primary">Update</button>
                      </div>
                    </form>
            <?php
                }
