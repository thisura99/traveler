...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            if (isset($_POST['edit_festival_sl_btn'])) {
                $id = $_POST['edit_festival_sl'];                

                $query = "SELECT * FROM festival_sl WHERE id='$id'";
            ...
            ?>
                    <form action="query.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <a href="home_about.php#festival_sri_lanka" class="btn btn-danger">Cancel</a>
                            <button type="submit" name="update_festival_sl_btn" class="btn btn-primary">Update</button>
                        </div>
                    </form>
            <?php
                }
