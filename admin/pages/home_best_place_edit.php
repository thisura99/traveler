...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            if (isset($_POST['edit_best_place_btn'])) {
                $id = $_POST['edit_best_place'];

                $query = "SELECT * FROM best_places WHERE id='$id'";
            ...
            ?>
                    <form action="query.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <a href="home_about.php#best_place_table" class="btn btn-danger">Cancel</a>
                            <button type="submit" name="update_best_place_btn" class="btn btn-primary">Update</button>
                        </div>
                    </form>
            <?php
                }
