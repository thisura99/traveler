...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            if (isset($_POST['edit_top_think_btn'])) {
                $id = $_POST['edit_top_think'];                

                $query = "SELECT * FROM top_thing WHERE id='$id'";
            ...
            ?>
                    <form action="query.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <a href="home_about.php#top_thing_table" class="btn btn-danger">Cancel</a>
                            <button type="submit" name="update_top_thing_btn" class="btn btn-primary">Update</button>
                        </div>
                    </form>
            <?php
                }
