                                ...
                                <div class="card">
                                    <div class="card-header row">
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="form-group">
                                                    <a class="card-link text-black" style="font-size: 20px;" data-toggle="collapse" href="#day01" aria-expanded="true" aria-controls="day01">Day 1 -
                                                        <label for="day_description">Day Description</label>
                                                        <input type="text" class="form-control" id="day_description" name="day_description" placeholder="Enter day description" required>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="flight" name="flight" placeholder="How Many" required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="day01" class="collapse">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="package_description" name="package_description" rows="4" placeholder="Enter package description"></textarea>
                                            </div>
                                            ...
                                            <div class="row  mb-2 mt-4">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="file" class="form-control" id="image1" name="image1" onchange="previewImage(event, 'image-preview1')">
                                                    <img id="image-preview1" src="#" alt="Image Preview" style="display: none; width: 100%; height: auto;">
                                                </div>
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="breakfast_location">Breakfast</label>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="breakfast_location">Location:</label>
                                                                <input type="text" class="form-control" id="breakfast_location" name="breakfast_location" placeholder="Enter breakfast location">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="breakfast">Details:</label>
                                                                <input type="text" class="form-control" id="breakfast" name="breakfast" placeholder="Enter breakfast details">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="lunch_location">Lunch</label>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="lunch_location">Location:</label>
                                                                <input type="text" class="form-control" id="lunch_location" name="lunch_location" placeholder="Enter lunch location">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="lunch">Details:</label>
                                                                <input type="text" class="form-control" id="lunch" name="lunch" placeholder="Enter lunch details">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="dinner_location">Dinner</label>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="dinner_location">Location:</label>
                                                                <input type="text" class="form-control" id="dinner_location" name="dinner_location" placeholder="Enter dinner location">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="dinner">Details:</label>
                                                                <input type="text" class="form-control" id="dinner" name="dinner" placeholder="Enter dinner details">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-4">
                                                            ...
                                                            <input type="file" class="form-control" id="image2" name="image2" onchange="previewImage(event, 'image-preview2')">
                                                            <img id="image-preview2" src="#" alt="Image Preview" style="display: none; width: 100%; height: auto;">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="image3">Image 3:</label>
                                                            <input type="file" class="form-control" id="image3" name="image3" onchange="previewImage(event, 'image-preview3')">
                                                            <img id="image-preview3" src="#" alt="Image Preview" style="display: none; width: 100%; height: auto;">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label for="image4">Image 4:</label>
                                                            <input type="file" class="form-control" id="image4" name="image4" onchange="previewImage(event, 'image-preview4')">
                                                            <img id="image-preview4" src="#" alt="Image Preview" style="display: none; width: 100%; height: auto;">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="image5">Image 5:</label>
                                                            <input type="file" class="form-control" id="image5" name="image5" onchange="previewImage(event, 'image-preview5')">
                                                            <img id="image-preview5" src="#" alt="Image Preview" style="display: none; width: 100%; height: auto;">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="activity_description" name="activity_description" rows="4" placeholder="Enter activity description"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php for ($day = 1; $day <= 5; $day++) { ?>
                                    <div class="card">
                                        ...
                                        <div id="day<?php echo $day; ?>" class="collapse">
                                            <!-- Add content for Day <?php echo $day; ?> here -->
