              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="pages/sri_lanka_places.php" class="dropdown-item">Top Places</a></li>
                    <li><a href="pages/sri_lanka_top_things.php" class="dropdown-item">Top Thing</a></li>
                    <li><a href="pages/sri_lanka_event_festival.php" class="dropdown-item">Festival</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Packages</a>
                  <ul class="dropdown-menu">
                    <li><a href="pages/sri_lanka_tour_packages.php" class="dropdown-item">Islandwide Tour</a></li>
                    <li><a href="pages/worldwide_tour_country_list.php" class="dropdown-item">Worldide Tour</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Services</a>
                  <ul class="dropdown-menu">
                    <li><a href="pages/hotels_srilanka.php" class="dropdown-item">Hotels</a></li>
