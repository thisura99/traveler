  ...
  <div class="container">
    ...
    ?>
      <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 1000px;">
        ...
        <h1 class="display-6 text-uppercase mb-0">Best Packages In <?php echo $packtitle; ?></h1>
      </div>
    <?php
    }
    ?>
          ...
          <div class="container">
            <div class="row">
              ...
              if (isset($_POST['load_packs_btn'])) {
                ...
                $query = "SELECT `id`, `place_1`, `place_2`, `price`, `rating`, `tour_name`, `tour_type`, `hotels`, `activities`, `transfers`, `nights`, `days`, `url`, `image` FROM `world_tour_packages` WHERE `pack_title` = '$packtitle'";
                      ...
                      <div class="destination shadow-sm">
                        ...
                        <div class="text p-3">
                          ...
                          <p class="bottom-area d-flex">
                            <small class="text-black"><i class="fa fa-book text-primary mr-2"></i><?php echo $tour_type; ?></small>
                            <span class="ml-auto"><a href="<?php echo $url; ?>">Discover</a></span>
                          </p>
                        </div>
                      </div>
                    </div>
