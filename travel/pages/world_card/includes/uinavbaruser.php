            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  <a href="pages/sri_lanka.html" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Sri
                    Lanka</a>
                  <ul class="dropdown-menu">
                    <li><a href="pages/sri_lanka_places.html" class="dropdown-item">Top Places</a></li>
                    <li><a href="pages/sri_lanka_top_things.html" class="dropdown-item">Top Thing</a></li>
                    <li><a href="#" class="dropdown-item">Festival</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a href="" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Packages</a>
                  <ul class="dropdown-menu">
                    <li><a href="pages/sri_lanka_tour_packages.html" class="dropdown-item">Islandwide Tour</a></li>
                    <li><a href="pages/worldwide_tour_packages.html" class="dropdown-item">Worldide Tour</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a href="" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Services</a>
                  <ul class="dropdown-menu">
                    <li><a href="" class="dropdown-item">Hotels</a></li>
